...
TRAJECTORY_BUILDER_2D.min_range = 0.01  -- ignore anything smaller than the robot radius, limiting it to the minimum scan range of the lidar
TRAJECTORY_BUILDER_2D.max_range = 5.5  -- the maximum scanning range of the lidar
